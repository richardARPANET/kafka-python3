...
try:
    ...
    from kafka3.vendor import selectors34 as selectors
...
from kafka3.metrics.stats import Avg, Count, Max, Rate
from kafka3.oauth.abstract import AbstractTokenProvider
from kafka3.protocol.admin import SaslHandShakeRequest, DescribeAclsRequest_v2, DescribeClientQuotasRequest
from kafka3.protocol.commit import OffsetFetchRequest
from kafka3.protocol.offset import OffsetRequest
from kafka3.protocol.produce import ProduceRequest
from kafka3.protocol.metadata import MetadataRequest
from kafka3.protocol.fetch import FetchRequest
from kafka3.protocol.parser import KafkaProtocol
from kafka3.protocol.types import Int32, Int8
from kafka3.scram import ScramClient
...
class BrokerConnection(object):
            ...
            if not self._can_send_recv():
                ...
                try:
                    ...
                    while not client_ctx.complete:
                        # calculate an output token from kafka3 token (or None if first iteration)
    ...
    def check_version(self, timeout=2, strict=False, topics=[]):
        ...
        from kafka3.protocol.admin import ApiVersionRequest, ListGroupsRequest
        from kafka3.protocol.commit import OffsetFetchRequest, GroupCoordinatorRequest
