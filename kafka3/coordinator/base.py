...
from kafka3.coordinator.heartbeat import Heartbeat
...
from kafka3.protocol.commit import GroupCoordinatorRequest, OffsetCommitRequest
from kafka3.protocol.group import (HeartbeatRequest, JoinGroupRequest,
